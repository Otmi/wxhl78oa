                ...
                <div class="head clearfix">
                   <!--  <div class="isw-grid"></div> -->
                    <form action="class/add">
						...
						<input type="text" placeholder="请输入班级类型" name="classType">
						<input type="text" placeholder="请输入班主任" name="adviserTeacher">
						<input type="text" placeholder="请输入讲师" name="trainerTeacher">
						<input type="text" placeholder="请输入开班时间" name="beginDate">
						<input type="text" placeholder="请输入学习时长" name="duration">
